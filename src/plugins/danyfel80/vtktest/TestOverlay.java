...
public class TestOverlay extends Overlay implements VtkPainter {
  ...
  private static final double[][] cube_vertices = new double[][] { {-10, -10, -10}, {-10, 10, -10}, {10, 10, -10},
  ...
  private void init() {
    ...
    /*
    // associate points to line sequence
    final vtkPolyLine lines = new vtkPolyLine();
    lines.GetPointIds().SetNumberOfIds(cube_vertices.length);
